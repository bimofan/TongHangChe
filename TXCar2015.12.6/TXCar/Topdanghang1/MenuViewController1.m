...
@interface MenuViewController1 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
//导航标题数组
...
-(void)setMenuBar
{
    ...
    //设置scrollView可以滚动的区域
    _headerScrollView.contentSize = CGSizeMake(80*_titleArray.count, 0);
