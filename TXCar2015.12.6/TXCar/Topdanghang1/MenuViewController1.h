...
@protocol MenuViewControllerDelegate1 <NSObject>
//控制滑动到第几个页面的方法
-(void)menuViewController:(id)vc currentPageChanged:(NSInteger)pageIndex;

@end

@interface MenuViewController1 : UIViewController
@property(nonatomic,assign) id<MenuViewControllerDelegate1>delegate;
