...
-(void)headerBeginRefreshing{
    ...
    bquery.limit = 10;
    [bquery whereKey:@"seeUserId" equalTo:[[BmobUser getCurrentUser]objectId]];
...
//#define RESERVE_SALER_CANCLE_SEE  23//卖家取消看车
    ...
    lable11.text=[NSString stringWithFormat:@"卖车人:%@",[[model objectForKey:@"sCar"]objectForKey:@"contactName"]];
